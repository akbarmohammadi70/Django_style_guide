...
DATABASES = {
    'default': env.db('DATABASE_URL', default='psql://user:password@127.0.0.1:5432/django_style_guide'),
}
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'django_style_guide.api.exception_handlers.drf_default_with_modifications_exception_handler',
